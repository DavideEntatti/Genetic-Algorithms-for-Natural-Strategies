...
Sistemato il problema nel secondo test, aggiungenod self loop su ogni stato in cui il pruning
...
Ho fatto una vrsione dei grafici dove ho rimosso l'ultima riga del csv, in quanto vitamin è andato in timeout (120 sec)
divrese volte.